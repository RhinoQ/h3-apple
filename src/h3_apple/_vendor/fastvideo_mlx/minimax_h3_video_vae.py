...
class MLXMiniMaxH3VideoVAE:
    ...
    def _decoder_block(self, *args, **kwargs):
        return _transformer_block(*args, **kwargs)
    ...
    def _decode_clip(self, z):
        ...
        tokens = self._decoder_linear(tokens, w["decoder.proj_in.weight"], w["decoder.proj_in.bias"])
        ...
        output = self._decoder_linear(hidden, w["decoder.proj_out.weight"], w["decoder.proj_out.bias"])[:num_patches]
