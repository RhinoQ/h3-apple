...
独立安装、自由提示词生成、模型准备、可选三方比较与研究基线连接均已完成。
...
五秒官方比较已[独立准备](../benchmarks/results/short-768p-01/README.md)。套件现在区分
五秒三路与十五秒 Ours/vpipe；原片 AAC 舍入修复仍要求音频覆盖交付，最终验收不变。
该项的新检查和权重可用性由链接中的记录维护，不覆盖已有正式失败。
