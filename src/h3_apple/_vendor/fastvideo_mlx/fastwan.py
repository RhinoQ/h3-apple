...
class MLXWanTransformerBlock:
    ...
    def __call__(self, hidden_states, encoder_hidden_states, temb, freqs_cis=None):
        ...
        if window > 0:
            from h3_apple._vendor.fastvideo_mlx.windowed_attention import windowed_attention
...
def mlx_dit_from_diffusers_safetensors(
    ...
    *,
    ...
    from h3_apple._vendor.fastvideo_mlx.checkpoint_compat import raise_if_unsupported_mlx_checkpoint
