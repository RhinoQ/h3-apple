...
@pytest.mark.parametrize("adapter", ["lightx2v", "dareties-fro0995"])
def test_full_mixed_pair_shares_states_and_rejects_dense_sparse_calls(tmp_path, monkeypatch, dense_sparse_calls, adapter):
